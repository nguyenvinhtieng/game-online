<template>
  ...
  >
    <div
      :class="
        cn(
          'flex items-center justify-center md:w-[58px] md:h-[58px] w-10 h-10 border border-primary rounded-xl text-primary border-dashed md:hover:bg-primary transition-all cursor-pointer hover:text-white hover:border-white',
