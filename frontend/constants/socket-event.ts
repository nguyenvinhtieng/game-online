export const SOCKET_EVENTS = {
    GAME: {
        ...
        TICTACTOE: {
            JOIN: 'GAME:TICTACTOE:JOIN',
            USER_TOKEN: 'GAME:TICTACTOE:USER_TOKEN',
            RE_CONNECT: 'GAME:TICTACTOE:RE_CONNECT',
            DATA: 'GAME:TICTACTOE:DATA',
            JOINED: 'GAME:TICTACTOE:JOINED',
            LIST: 'GAME:TICTACTOE:LIST',
            REGISTER_LIST: 'GAME:TICTACTOE:REGISTER_LIST',
            UNREGISTER_LIST: 'GAME:TICTACTOE:UNREGISTER_LIST',
            CHANGE_NAME: 'GAME:TICTACTOE:CHANGE_NAME',
            UPDATE_PLAYER_STATUS: 'GAME:TICTACTOE:UPDATE_PLAYER_STATUS',
            TIC: 'GAME:TICTACTOE:TIC',
        }
    },
